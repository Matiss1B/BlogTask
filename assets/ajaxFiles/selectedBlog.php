...
$b = 0;
$user = 0;
$sql = "SELECT img.img,img.idI, img.is_main, img.blog_id, blog.id, blog.title, blog.description, blog.user_id
FROM img
INNER JOIN blog ON img.blog_id = blog.id AND img.is_main = 1 AND blog.id ='$blog_id'";
...
if ($result->num_rows > 0) {
    ...
    $i++;
        ?><div class="blog flexColumn">
                    ...
                    <p onclick = "commentsHide(<?php echo $i;?>)" class = "more-comments-btn none" id = "hideComs">All comments</p>
